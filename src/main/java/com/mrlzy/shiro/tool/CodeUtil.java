...
public class CodeUtil {
	private static Log log = LogFactory.getLog(CodeUtil.class);
	...
	public static String encryptMd5(String in) {
		try {
	...
	*/
	public static void main(String[] args) throws IOException {
	   ...
	   System.out.println("间隔时间：" + time);*/
		   // String str="123456";
		    //String strEncrypto = CodeUtil.encryptBase64(str,Application.dbKey);
		    //System.out.println("被加密的字符串：" + str + "\r\n加密后的结果：" + strEncrypto);
		    //String strDecrypto = CodeUtil.decryptBase64(strEncrypto,Application.dbKey);
		    //System.out.println("解密后的结果：" + strDecrypto);


		 /*System.out.println(CodeUtil.encryptMd5("111111"));
		 System.out.println(CodeUtil.encryptMd5("111111"));
		 System.out.println(CodeUtil.encryptMd5("111111"));   */
